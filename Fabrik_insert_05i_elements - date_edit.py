...
print("FABRIK INSERT ELEMENT FIELD DATE_EDIT STEP 5")
print("--------------------------------------------")
...
funcfile.writelog("SCRIPT: FABRIK_INSERT_05_ELEMENT_DATE_EDIT")
funcfile.writelog("------------------------------------------")
...
# Script log file
funcfile.writelog("---------------------------------------------")
funcfile.writelog("COMPLETED: FABRIK_INSERT_05_ELEMENT_DATE_EDIT")
