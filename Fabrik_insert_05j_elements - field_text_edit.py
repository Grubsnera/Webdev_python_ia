...
"tiplocation":"right",
"inc_in_adv_search":"1",
"php-validation_condition":["return True;"],
"php-match":["0"],
"validations":{"plugin":["php"],"plugin_published":["1"],"validate_in":["both"],"validation_on":["both"],"validate_hidden":["1"],"must_validate":["0"],"show_icon":["0"]}
}'
""" + ");"

# work "php-validation_condition":["if (empty($data)) {return true;} else {return false;}"],
# does not work "php-code":["$user = JFactory::getUser();$userid = $user->username;return "'.$userid.'";"],
# work "php-match":["0"],
# work "validations":{"plugin":["php"],"plugin_published":["1"],"validate_in":["both"],"validation_on":["both"],"validate_hidden":["1"],"must_validate":["0"],"show_icon":["0"]}
