...
print("FABRIK INSERT ELEMENT FIELD DATE_CREATE STEP 5")
print("----------------------------------------------")
...
funcfile.writelog("SCRIPT: FABRIK_INSERT_05_ELEMENT_DATE_CREATE")
funcfile.writelog("--------------------------------------------")
...
# Script log file
funcfile.writelog("-----------------------------------------------")
funcfile.writelog("COMPLETED: FABRIK_INSERT_05_ELEMENT_DATE_CREATE")
