"""
Script to INSERT Joomla Fabrik form decimal record
Copyright: AB Janse van Rensburg on 2019-01-31
"""
...
# Input the maximum field length
print("")
print("Default:"+sd_max)
s_max = input("Maximum field length? ")
if s_max == "":
    s_max = sd_max
    
# Input the integer field length
print("")
print("Default:"+sd_int)
s_int = input("Integer field length? ")
if s_int == "":
    s_int = sd_int

# Input the decimal field length
print("")
print("Default:"+sd_dec)
s_dec = input("Decimal field length? ")
if s_dec == "":
    s_dec = sd_dec
...
s_sql = s_sql.replace("%MAX%",s_max)
s_sql = s_sql.replace("%INT%",s_int)
s_sql = s_sql.replace("%DEC%",s_dec)
curs.execute(s_sql)
cnxn.commit()
