...
print("FABRIK INSERT ELEMENT INTERNALID STEP 5")
print("---------------------------------------")
...
funcfile.writelog("SCRIPT: FABRIK_INSERT_05_ELEMENT_INTERNALID")
funcfile.writelog("-------------------------------------------")
...
# INTERNALID element param defaults
"""
{
"show_in_rss_feed":"0",
...
# Script log file
funcfile.writelog("----------------------------------------------")
funcfile.writelog("COMPLETED: FABRIK_INSERT_05_ELEMENT_INTERNALID")
